 ...
 * @author Eduardo
 */
class MyFrameClass2 extends JFrame implements ListSelectionListener {
        ...
        public static void main(String[] args) {
                Runnable runner = new Runnable() {
                        public void run() {
                                ...
                                // Ventana principal 
                                final MyFrameClass2 frame = 
                                        new MyFrameClass2("Ventana Subclase de JFrame con Lista Seleccionable y Scroll");
