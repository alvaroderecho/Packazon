 ...
 * @author Eduardo
 */
class MyFrameClass4 extends JFrame implements ListSelectionListener {
    ...
    public MyFrameClass4(String text) {
        super(text);
        ...
        public static void main(String[] args) {
                Runnable runner = new Runnable() {
                        public void run() {
                                ...
                                // Ventana principal 
                                final MyFrameClass4 frame = 
                                        new MyFrameClass4("Ventana Subclase de JFrame con DOS Lista Seleccionables");
