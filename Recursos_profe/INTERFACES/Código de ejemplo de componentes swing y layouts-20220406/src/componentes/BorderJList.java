 ...
 * @author Eduardo
 */
class MyFrameClass1 extends JFrame implements ListSelectionListener {
    ...
    public MyFrameClass1(String text) {
        super(text);
        ...
        public static void main(String[] args) {
                Runnable runner = new Runnable() {
                        public void run() {
                                ...
                                // Ventana principal 
                                final MyFrameClass1 frame = 
                                        new MyFrameClass1("Ventana Subclase de JFrame con ListaSeleccionable");
