 ...
 * @author Eduardo
 */
class MyFrameClass3 extends JFrame implements ListSelectionListener {
    ...
    public MyFrameClass3(String text) {
        super(text);
        ...
        public static void main(String[] args) {
                Runnable runner = new Runnable() {
                        public void run() {
                                ...
                                // Ventana principal 
                                final MyFrameClass3 frame = 
                                        new MyFrameClass3("Ventana Subclase de JFrame con ListaSeleccionable");
