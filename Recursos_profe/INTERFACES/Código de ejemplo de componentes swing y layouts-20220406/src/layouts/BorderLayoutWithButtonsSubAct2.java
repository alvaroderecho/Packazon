 ...
 *
 */
class MyFrameClass2 extends JFrame implements ActionListener {	
	private static final long serialVersionUID = 9118673928693575927L;

	private JButton button1, button2, button3, button4, button5;
		
	public MyFrameClass2(String text) {
		super(text);
...
public class BorderLayoutWithButtonsSubAct2 {
	...
	public static void main(String[] args) {
		Runnable runner = new Runnable() {
			public void run() {
				// Ventana principal 
				final MyFrameClass2 frame = new MyFrameClass2("Una Ventana de Ejemplo que Hereda de JFrame con Listeners en la misma clase");
			}
		};
